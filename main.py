...
def print_results(data: list[Sale]) -> None:
    ...
    for sale in data:
        ...
        print(f'| {"Order Priority".ljust(15, ".")}{sale.order_priority.rjust(35, ".")} |')
        print(f'| {"Sales Channel".ljust(15, ".")}{sale.sales_channel.rjust(35, ".")} |')
        print(f'| {"Region".ljust(10, ".")}{sale.region.rjust(40, ".")} |')
        print(f'| {"Country".ljust(10, ".")}{sale.country.rjust(40, ".")} |')
        print(f'| {"Order Date".ljust(10, ".")}{str(sale.order_date).rjust(40, ".")} |')
        print(f'| {"Ship Date".ljust(10, ".")}{str(sale.ship_date).rjust(40, ".")} |')
        print(f'| {"Item Type".ljust(10, ".")}{sale.item_type.rjust(40, ".")} |')
